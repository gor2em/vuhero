...
import { ref } from "vue";
import Sidebar from "./components/utils/sidebar/Sidebar.vue";
...
<template>
  <div class="flex">
    ...
    <main class="w-full">
      <header class="sticky top-0 border-b bg-white/50">
        <div class="backdrop-blur-sm">
          <div class="flex items-center justify-between p-4 h-14">
            ...
            <div>
              <div id="UserCard" class="flex items-center">
                <span
                  class="flex items-center justify-center text-sm font-medium text-white rounded-full w-8 h-8 bg-teal-400"
                >
                  go
                  <!-- {{ getFirstTwoLetter(username) }} -->
                </span>
